...
- [ ] 3. PDF Parsing Service
  ...
  - [~] 3.5 Write property-based tests for Property 5 (every chunk has a valid page number in `[1, N]`) and Property 6 (chunk token counts in `[400, 600]` except last-chunk merge) — min 100 examples each.
  - [~] 3.6 Write unit tests for: OCR fallback trigger, blank-page logging, sentence-boundary splitting, and final-chunk merging.
