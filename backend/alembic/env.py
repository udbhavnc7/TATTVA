...
All ORM models are imported so Alembic can auto-detect schema changes.
"""
...
# Set up loggers from alembic.ini if a logging config section is present.
...
def run_migrations_offline() -> None:
    ...
    Emits SQL to stdout rather than connecting to the database.
    Useful for generating migration SQL scripts for review.
    """
